<head>
    ...
    {{-- Load cả file app chung (cho header) và file riêng của trang sản phẩm --}}
    @vite([
                ...
                <div class="wt-products-grid" id="wtProductsGrid">
                    ...
                    <div class="wt-product-info">
                        ...
                        <div class="wt-product-specs">
                            <span class="wt-product-spec">⚙️ </span>
                            <span class="wt-product-spec">📏 </span>
                            <span class="wt-product-spec">💎 </span>
                        </div>
                        <div class="wt-product-price-section">
                            <span class="wt-product-price">M VNĐ</span>
